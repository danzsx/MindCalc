    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="bg-primary text-primary-foreground px-6 py-2 rounded-lg hover:bg-[#14B8A6] transition-all duration-300"
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 lg:py-28">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl lg:text-2xl text-muted-foreground mb-8 leading-relaxed">
              Se você sempre teve dificuldade com números, o MindCalc é pra você. 
              Aqui você aprende com macetes simples, treinos curtos e no seu ritmo.
            </p>

            {/* CTA Principal */}
            <button
              onClick={onGetStarted}
              className="inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-8 py-5 rounded-xl hover:bg-[#14B8A6] shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 text-lg min-h-[56px]"
              style={{ fontWeight: 'var(--font-weight-medium)' }}
            >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              O MindCalc não é mais um app de matemática chato. 
              É uma forma diferente de aprender a pensar com números.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-card rounded-[20px] p-8 shadow-[0_10px_15px_-3px_rgba(0,0,0,0.05)] hover:shadow-[0_15px_25px_-5px_rgba(0,0,0,0.1)] transition-shadow duration-300">
              ...
              <p className="text-muted-foreground leading-relaxed">
                O app percebe o seu nível real e vai ajustando as contas. 
                Sem te forçar, sem te jogar em níveis impossíveis. 
                Você avança conforme vai ficando mais confortável.
              </p>
            </div>
            ...
            <div className="bg-card rounded-[20px] p-8 shadow-[0_10px_15px_-3px_rgba(0,0,0,0.05)] hover:shadow-[0_15px_25px_-5px_rgba(0,0,0,0.1)] transition-shadow duration-300">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Acompanhe seu progresso de um jeito visual e simples. 
                Veja onde você melhorou, quais contas estão ficando mais fáceis. 
            ...
            <div className="bg-card rounded-[20px] p-8 shadow-[0_10px_15px_-3px_rgba(0,0,0,0.05)] hover:shadow-[0_15px_25px_-5px_rgba(0,0,0,0.1)] transition-shadow duration-300">
              ...
              <p className="text-muted-foreground leading-relaxed">
                A inteligência artificial do MindCalc não é complicada: 
                ela só te dá dicas e macetes quando você trava. 
                Como ter alguém paciente do seu lado.
              </p>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="text-foreground mb-1" style={{ fontWeight: 'var(--font-weight-medium)' }}>
                      Treinos de 3 minutos
                    </div>
                    <div className="text-muted-foreground text-sm">
                      Exercícios rápidos que cabem na sua rotina, sem ocupar seu dia
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-muted-foreground text-sm">
                      Errou? Sem problema. O app não te julga, só te ajuda a entender
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-card rounded-[20px] p-8 lg:p-12 shadow-[0_10px_15px_-3px_rgba(0,0,0,0.05)]">
              <div className="space-y-6">
                <div className="bg-primary/5 rounded-xl p-6 border border-primary/20">
                  <div className="text-primary mb-2" style={{ fontWeight: 'var(--font-weight-semibold)' }}>
                    💡 Exemplo de macete
                  </div>
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    ...
                    <br />
                    36 ÷ 2 = 18 → <span className="text-primary">180</span>
                  </p>
                </div>

                <div className="bg-secondary/10 rounded-xl p-6 border border-secondary/30">
                  <div className="text-foreground mb-2" style={{ fontWeight: 'var(--font-weight-semibold)' }}>
                    ✨ Resultado
                  </div>
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    Com o tempo, você para de travar e começa a calcular naturalmente, 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-card rounded-[20px] p-6 shadow-[0_10px_15px_-3px_rgba(0,0,0,0.05)] text-left">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                <br />
                e sente que trava na hora de fazer contas de cabeça
              </p>
            </div>
            ...
            <div className="bg-card rounded-[20px] p-6 shadow-[0_10px_15px_-3px_rgba(0,0,0,0.05)] text-left">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                <br />
                e quer parar de depender tanto da calculadora
              </p>
            </div>
            ...
            <div className="bg-card rounded-[20px] p-6 shadow-[0_10px_15px_-3px_rgba(0,0,0,0.05)] text-left">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                <br />
                e já passou por experiências ruins na escola
              </p>
            </div>
            ...
            <div className="bg-card rounded-[20px] p-6 shadow-[0_10px_15px_-3px_rgba(0,0,0,0.05)] text-left">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                <br />
                e aprender do jeito que faz sentido pra você
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-3xl mx-auto px-6 lg:px-12 text-center">
          ...
          <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
            Comece agora e veja como calcular mentalmente pode ser mais fácil do que você imagina.
          </p>
      ...
      <footer className="border-t border-border py-8">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-primary" style={{ fontFamily: 'var(--font-family-display)', fontSize: '1.5rem' }}>
              MindCalc
            </div>
