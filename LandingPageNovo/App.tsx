...
type PageType = 'landing' | 'dashboard' | 'lessons' | 'training' | 'billing';
                        ...
                        <div className="flex items-center gap-8">
                            ...
                            <nav className="hidden md:flex items-center gap-6">
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-all duration-300 ${currentPage === 'dashboard'
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-all duration-300 ${currentPage === 'lessons'
                                            ? 'text-foreground bg-muted'
                                            : 'text-muted-foreground hover:text-primary hover:bg-muted'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-all duration-300 ${currentPage === 'training'
                                            ? 'text-foreground bg-muted'
                                            : 'text-muted-foreground hover:text-primary hover:bg-muted'
                                        }`}
                                >
                            ...
                            <button
                                ...
                                className={`hidden lg:flex items-center gap-2 px-4 py-2 rounded-lg transition-all duration-300 ${currentPage === 'billing'
